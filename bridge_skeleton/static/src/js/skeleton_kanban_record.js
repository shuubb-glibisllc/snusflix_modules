odoo.define('@bridge_skeleton/static/src/js/SkeletonKanbanRecord', ["@web/views/kanban/kanban_record"], function (require) {
    "use strict";

    // var KanbanRecord = require('web.KanbanRecord');
    var KanbanRecord = require('@web/views/kanban/kanban_record');
