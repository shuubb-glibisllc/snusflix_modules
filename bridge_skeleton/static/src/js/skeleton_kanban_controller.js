odoo.define('@bridge_skeleton/static/src/js/SkeletonKanbanController', ["@web/legacy/js/services/core", "@web/views/kanban/kanban_controller", "@bridge_skeleton/static/src/js/SkeletonKanbanWidget"], function (require) {
    "use strict";



    var core = require('@web/legacy/js/services/core');
    var KanbanController = require('@web/views/kanban/kanban_controller');
