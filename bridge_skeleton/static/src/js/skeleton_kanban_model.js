odoo.define('@bridge_skeleton/static/src/js/SkeletonKanbanModel', ["@web/model/relational_model/relational_model"], function (require) {
    "use strict";



    var KanbanModel = require('@web/model/relational_model/relational_model');
