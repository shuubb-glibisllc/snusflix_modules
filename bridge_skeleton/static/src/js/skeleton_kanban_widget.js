odoo.define('@bridge_skeleton/static/src/js/SkeletonKanbanWidget', ["@web/legacy/js/services/core", "@web/views/fields/x2many/x2many_field", "@web/session", "@web/legacy/js/core/widget"], function (require) {
    "use strict";

    var core = require('@web/legacy/js/services/core');
    var relationalFields = require('@web/views/fields/x2many/x2many_field');
    var session = require('@web/session');
    var Widget = require('@web/legacy/js/core/widget');
